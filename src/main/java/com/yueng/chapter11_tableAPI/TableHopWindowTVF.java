...
/**
 * @author RizzoYueng
 * @create 2023-10-11-12:35
 */
public class TableHopWindowTVF {
    public static void main(String[] args) throws Exception {
        ...
        // 窗口实现
        Table hopResult = tableEnv.sqlQuery("select username, window_end, count(1) from table(HOP(TABLE clickTable, DESCRIPTOR(et), INTERVAL '2' SECOND,INTERVAL '10' SECOND)) " +
