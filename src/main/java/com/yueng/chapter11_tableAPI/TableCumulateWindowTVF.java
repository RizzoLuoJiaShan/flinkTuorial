...
/**
 * @author RizzoYueng
 * @create 2023-10-11-13:05
 */
public class TableCumulateWindowTVF {
    public static void main(String[] args) throws Exception {
        ...
        // 窗口实现
        Table hopResult = tableEnv.sqlQuery("select username, window_end, count(1) from table(CUMULATE(TABLE clickTable, DESCRIPTOR(et), INTERVAL '2' SECOND,INTERVAL '10' SECOND)) " +
                "group by username, window_start, window_end");
        // 转换为流输出
        tableEnv.toDataStream(hopResult).print();
        env.execute();
    }
}
